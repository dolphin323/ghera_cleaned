...
public class Tests {
    ...
    public void testPresenceOfVulnerability() throws UiObjectNotFoundException {
        ...
        assertEquals(bibleText.getText(), "This is written by Secure");
        ...
        assertEquals(result.getText(), "Unable to write into file");
        mDevice.pressHome();
        ...
        bibleText = mDevice.findObject(new UiSelector()
                .resourceId(BENIGN_APP_PACKAGE + ":id/bibleText"));
        assertThat(bibleText.getText(), equalTo("This is written by Secure"));
    }
}
