...
public class Tests {
    ...
    public void testAbsenceOfVulnerability() throws UiObjectNotFoundException {
        ...
        UiObject getdos_btn = mDevice.findObject(new UiSelector().resourceId(MALICIOUS_APP_PACKAGE + ":id/dos"));
        assertThat(getdos_btn, notNullValue());
        getdos_btn.click();
        UiObject dispRes = mDevice.findObject(new UiSelector().resourceId(BENIGN_APP_PACKAGE + ":id/concat"));
        assertEquals("NullPointerException", dispRes.getText());
    }
}
