...
public class Tests {
    ...
    private void setupDevice() {
        ...
        UiObject uiObject = mDevice.findObject(new UiSelector().text("GOT IT"));
        try {
            uiObject.click();
        } catch (UiObjectNotFoundException e) {
            e.printStackTrace();
        }
        uiObject = mDevice.findObject(new UiSelector().text("OK"));
        try {
            uiObject.click();
        } catch (UiObjectNotFoundException e) {
            e.printStackTrace();
    ...
    public void testPresenceOfVulnerability() throws UiObjectNotFoundException {
        ...
        msgApps.click();
        UiObject text = mDevice.findObject(new UiSelector().textContains("Benign:"));
        text.getText();
    }
}
