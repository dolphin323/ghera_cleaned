...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static boolean userApproval = false;
    ...
    public void getUserApproval() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(mContext);
        alertDialog.setTitle("User Approval");
        alertDialog
                .setMessage("This webpage is requesting your location. Do you want to grant it access?");
