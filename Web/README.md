...
7. **WebViewInterceptRequest-MITM-Lean** Apps that do not validate resource request before loading them into a WebView are vulnerable to MitM attacks.

8. **WebViewOverrideUrl-MITM-Lean** Apps that do not validate page requests made from within a WebView, are vulnerable to MitM attcaks.
